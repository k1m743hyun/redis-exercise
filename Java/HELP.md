...
* The original package name 'com.thkim0022.redis-exercise' is invalid and this project uses 'com.thkim0022.redisexercise' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/docs/2.7.7-SNAPSHOT/reference/htmlsingle/#data.nosql.redis)
